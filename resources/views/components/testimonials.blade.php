<section class="page-section-ptb gray-bg testimonial-slider">
   <div class="container">
     <div class="row">
       <div class="col-md-12">
         <div class="owl-carousel" data-nav-dots="true" data-items="2" data-md-items="2" data-sm-items="1">
           <div class="item">
             <div class="testimonial">
               <div class="testimonial-avatar"> <img alt="" src="{{ asset('images/team/01.jpg') }}"> </div>
           ...
           <div class="item">
             <div class="testimonial">
               <div class="testimonial-avatar"> <img alt="" src="{{ asset('images/team/02.jpg') }}"> </div>
           ...
           <div class="item">
             <div class="testimonial">
               <div class="testimonial-avatar"> <img alt="" src="{{ asset('images/team/03.jpg') }}"> </div>
